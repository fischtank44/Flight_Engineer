...
if make_plots==True:
    ...
    for name, ax in zip(univariate_plot_names, axs.flatten()):
        plot_one_univariate(ax, df, target_variable, name )        
        # print(name, ax)
...
################  The plot is showing some level of predictive ability   ############
####   Zoom plot of each feature #### Only use for close analysis ######
